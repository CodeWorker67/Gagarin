...
from config_bd.models import AsyncSessionLocal, Users, Payments, Gifts, PaymentsCryptobot, PaymentsStars, Online, \
    WhiteCounter, PaymentsCards, PaymentsPlategaCrypto, PaymentsFkSBP, PaymentsWataSBP, PaymentsWataCard
...
class AsyncSQL:
    ...
    async def get_stat_by_ref_or_stamp(self, arg: str) -> Tuple[Optional[int], Optional[int], Optional[int], Optional[int], Optional[int], Optional[str]]:
        ...
        (total, with_sub, with_tarif, with_tarif_not_blocked, total_payments, source)
    ...
    def get_parameters(self) -> List[str]:
        """Список ключей категорий рассылки (совпадает с /broadcast)."""
        return [
