...
CUSTOM_PRESETS = [
    ...
    ("buy_tier_3", "🔹 Тарифы на 3 устройства", STYLE_PRIMARY),
    ("buy_tier_5", "🔸 Тарифы на 5 устройств", STYLE_PRIMARY),
    ("buy_tier_10", "🏆 Тарифы на 10 устройств", STYLE_SUCCESS),
    ("r_m3_d5", "🔸 3 мес — 5 устройств — 749 ₽", STYLE_SUCCESS),
    ("r_m12_d5", "🔸 12 мес — 5 устройств — 1799 ₽", STYLE_SUCCESS),
...
def _ref_invite_url(user_id: int) -> str:
    ...
    text = urllib.parse.quote("🚀 Ссылка на Gagarin VPN для тебя!")
